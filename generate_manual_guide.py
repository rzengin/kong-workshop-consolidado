...
3. Haz clic en el botón superior derecho **New Control Plane**.
   ![Nuevo Control Plane](images/ui_new_cp.png)
...
3. Haz clic en **New Plugin**.
   ![Nuevo Plugin](images/ui_new_plugin.png)
...
2. Haz clic en **New Team**.
   ![Nuevo Team](images/ui_new_team.png)
...
2. Haz clic en **New Service**.
   ![Nuevo Service](images/ui_new_service.png)
3. **Servicio Flights:**
   - **Name:** `flights`
...
3. Haz clic en el botón **Edit** (esquina superior derecha).
   ![Editar Ruta](images/ui_edit_route.png)
...
9. Haz clic en **New Consumer**.
   ![Nuevo Consumer](images/ui_new_consumer.png)
...
6. Ve a la pestaña **Credentials** -> **New ACL Credential**.
   ![Nueva ACL Credential](images/ui_new_acl.png)
